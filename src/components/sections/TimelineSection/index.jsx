      ...
      <div className="container">
        <div className={styles['timeline__frame']}>
          ...
          <div className={styles['timeline__title']}>
            ...
            <span className={styles['timeline__title2']}>
        ...
        <div className={styles['timeline__group']}>
          <div className={styles['timeline__container-1']}>
            ...
            <div className={styles['timeline__group-up2']}>
              <b>II. Giai đoạn 2</b>
              <div className={styles['timeline__date1']}>16/10</div>
              <span className={styles['timeline__content_1']}>
                <h6 className={styles['timeline__title3']}>
                  Workshop hướng dẫn thi đấu
                </h6>
                <p className={styles['timeline__title4']}>
                  Tại đây, bạn sẽ được tìm hiểu về quy tắc cuộc thi, cách thức
                  nộp bài và những mẹo quan trọng để vượt qua các thử thách CSS.
                </p>
              </span>
            </div>
            ...
            <div className={styles['timeline__group-up4']}>
              <b>IV. Giai đoạn 4</b>
              <div className={styles['timeline__date2']}>25/10</div>
              <span className={styles['timeline__content_1']}>
                <h6 className={styles['timeline__title5']}>
                  Vòng chung kết giải đấu
                </h6>
                <p className={styles['timeline__title4']}>
                  Vòng chung kết sẽ là cuộc đối đầu quyết định, nơi những
                  &quot;Chiến thần CSS&quot; tài ba nhất sẽ tranh tài để tìm ra
                  vị vua CSS thực sự của &quot;CSS Battle&quot;.
                </p>
              </span>
            </div>
          </div>
          ...
          <div className={styles['timeline__container-3']}>
            <div className={styles['timeline__group-up6']}>
              ...
              <span className={styles['timeline__content_1']}>
                ...
                <p className={styles['timeline__title4']}>
                  Hãy tranh thủ đăng ký ngay để không bỏ lỡ cơ hội tham gia cuộc
                  thi đầy hấp dẫn này. Đơn đăng ký sẽ được tiếp nhận trong
                  khoảng thời gian trên để đảm bảo mọi người có đủ thời gian
            ...
            <div className={styles['timeline__group-up7']}>
              <b>III. Giai đoạn 3</b>
              <div className={styles['timeline__date4']}>21/10 và 23/10</div>
              <span className={styles['timeline__content_1']}>
                <h6 className={styles['timeline__title7']}>
                  Vòng loại và bán kết giải đấu
                </h6>
                <p className={styles['timeline__title4']}>
                  Bước vào vòng loại và bán kết, các bạn sẽ đối mặt với những
                  thử thách CSS đầy kịch tính và căng thẳng. Hãy chuẩn bị tinh
                  thần và sẵn sàng để thể hiện tài năng của mình trong việc sử
                  dụng CSS và chiến đấu để giành vé vào vòng chung kết.
                </p>
              </span>
            </div>
